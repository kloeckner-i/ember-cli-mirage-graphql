...
//   });
//
//   test('it can unwrap a concrete type from an interface type', function(assert) {
//     let typeName = 'Foo';
//     let type = new GraphQLObjectType({ name: typeName });
//     let fieldNodes = [{
//       selectionSet: {
//         selections: [{
//           typeCondition: {
...
//       }
//     }];
//     let schema = { _typeMap: { Foo: type } };
//     let unwrapperFn = maybeUnwrapInterfaceType(fieldNodes, schema);
//
//     assert.equal(unwrapperFn().type, type);
//   });
// });
